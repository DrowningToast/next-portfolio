...
const Resume = () => {
  return (
    <div className="flex max-w-full flex-col items-center justify-around gap-y-8 whitespace-break-spaces px-6 py-16 font-sans text-tertiary md:max-w-2xl md:px-14 lg:max-w-4xl lg:items-start lg:px-24 xl:max-w-6xl">
      <div className="space-y-4">
        <h2 className="font-eb text-2xl font-semibold">Get to know me</h2>
      ...
      <div className="space-y-4">
        <span className="font-eb text-3xl font-semibold text-primary">
          Experiences
        </span>
        <div className="flex flex-col gap-y-6">
          <div className="space-y-1">
            <span className="text-lg font-medium">
              Teaching Assistant at <span className="whitespace-nowrap">School of Information Technology,</span> KMITL.<span className="whitespace-nowrap font-mono text-sm">July 2023 - Present</span>
            </span>
            <ul className="list-inside list-disc text-sm text-gray-300 md:text-base">
          ...
          <div className="space-y-1">
            <span className="text-lg font-medium">
              SiData+, Siriraj<span className="whitespace-nowrap">(Frontend Developer Internship).</span><span className="whitespace-nowrap font-mono text-sm">Mar - May 2021</span>
            </span>
            <ul className="list-inside list-disc text-sm text-gray-300 md:text-base">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-y-6">
          <div className="space-y-1">
            <h5 className="text-lg font-medium">
              IT Experience Club - Vice-President.<span className="whitespace-nowrap font-mono text-sm">July 2023 - Now</span> <Link className="text-sm text-primary underline" target="_blank" href="https://www.facebook.com/ITxKMITL">(click)</Link>
            </h5>
          ...
          <div className="space-y-1">
            <h5 className="text-lg font-medium">
              ToBeIT’67 Camp <span className="whitespace-nowrap">(Head of academic, Teaching Director)</span>.<span className="whitespace-nowrap font-mono text-sm">Oct - Nov 2023</span>
            </h5>
            <span className="text-sm text-gray-300 md:text-base">
          ...
          <div className="space-y-1">
            <h5 className="text-lg font-medium">
              Sairahut IT20 <span className="whitespace-nowrap">(Event Staff, Head of Technology).</span><span className="whitespace-nowrap font-mono text-sm">July - Aug 2023</span>
            </h5>
            <span className="text-sm text-gray-300 md:text-base">
          ...
          <div className="space-y-1">
            <h5 className="text-lg font-medium">
              ITCAMP 19 <span className="whitespace-nowrap">(Website Camp Teaching Director)</span><span className="whitespace-nowrap font-mono text-sm">May - Jun 2023</span>
            </h5>
            <span className="text-sm text-gray-300 md:text-base">
